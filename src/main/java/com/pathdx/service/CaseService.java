...
// ⛔️ Do NOT annotate interfaces with @Service
public interface CaseService {

    ResponseDto<CaseImageResponseDto> getImagesForCase(
            String labId, String accessionId, String caseId, String email);

    ResponseDto<CaseListingDto> getCaseListing(
            String userMail,
            String labId,
            ...
            int pageNo,
            int pageSize
    ) throws LabNotFoundException, Exception;
    ...
    ResponseDto<CaseResponseDto> getCaseInfo(
            Optional<Long> caseId, Long orderMessageId, String labId
    ) throws Exception;
}
